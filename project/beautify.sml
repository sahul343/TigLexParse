...
struct
  ...
  fun indent space (Ast.Op(a, Ast.Plus, b)) = "("^(indent 0 a)^"+"^(indent 0 b)^")"
    |indent space (Ast.Op(a, Ast.Minus, b)) = "("^(indent 0 a)^"-"^(indent 0 b)^")"
    |indent space (Ast.Op(a, Ast.Mul, b)) = (indent 0 a)^"*"^(indent 0 b)
    |indent space (Ast.Op(a, Ast.Divide, b)) = (indent 0 a)^"/"^(indent 0 b)
